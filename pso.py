...
def main(pcls, w, run):
    ...
    sol.to_csv("./solutions/each_run/sol_file_kp_16_50_1000_pcls_{0}_w_{1}_run_{2}.csv".format(pcls, w, run))
...
for pcls in [10, 30]:
    for w in [0.3, 0.7, 0.9]:
        ...
        df.to_csv("./solutions/sol_file_kp_16_50_1000_pcls_{0}_w_{1}.csv".format(pcls, w))
